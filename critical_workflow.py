...
def check_ulimit_files():
    ...
    print('ulimit stdout type', type(stdout))
...
if __name__ == '__main__':
    ...
    if "1" not in stdout:
        ...
        data = """var a = ["updateEventsStatus","batchEventsProcessing","rtEventsProcessing","rtEventsProcessing2"]
        ...
        create_file("/tmp/start_workflow.js", data)
        ...
        print("stdout " + stdout)
        if stdout != 1:
            unconditional_data = """var a = ["updateEventsStatus","batchEventsProcessing","rtEventsProcessing","rtEventsProcessing2"]
                            a.forEach(function(entry) {
                                countWkf=sqlGetInt("Select count(*) from xtkworkflow where """ + query_param + """='" + entry + "' and ifailed=1")
                                if (countWkf != 0){
            ...
            create_file("/tmp/stop_workflow.js", unconditional_data)
